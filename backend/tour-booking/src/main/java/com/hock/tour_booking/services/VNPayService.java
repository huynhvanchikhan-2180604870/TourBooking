...
import com.hock.tour_booking.config.VNPayConfig;
...
public class VNPayService {
    ...
    public Map<String, Object> createOrder(PaymentRequest paymentRequest, Booking booking) {
        ...
        vnp_Params.put("vnp_OrderInfo", paymentRequest.getOrder_id());
...
//        Payment savePayment = paymentService.createPayment(payment);
        ...
        kq.put("vnp_BankCode", vnp_Params.get("vnp_BankCode"));
        kq.put("vnp_BankTranNo", vnp_Params.get("vnp_BankTranNo"));
        kq.put("vnp_CardType", vnp_Params.get("vnp_CardType"));
        kq.put("vnp_PayDate", vnp_Params.get("vnp_PayDate"));
